...
const buildEventInputBlock = (event: CalendarEvent) => {
...
export const buildClassifierUserPrompt = (event: CalendarEvent): string => {
  return [
    '# 指示',
...
export const buildClassifierMessages = (event: CalendarEvent): ChatMessage[] => [
  {
    role: 'system',
